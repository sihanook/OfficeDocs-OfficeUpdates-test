...
- <div>We fixed an issue in inserting files as object from OneDrive</div>
...
- <div>Outlook: Improved our recovery steps to f<span>ix an issue that caused graphical content to get deleted from email threads.&nbsp;</span></div>
